from resultstoresearchapi import (invocation_pb2, common_pb2, timestamp_pb2,
                                  duration_pb2, resultstore_download_pb2, file_pb2,
                                  wrappers_pb2, target_pb2)
...
def mock_file():
    return file_pb2.File(uid='test-file', length=mock_int_64_value(), content_type='text/html')
