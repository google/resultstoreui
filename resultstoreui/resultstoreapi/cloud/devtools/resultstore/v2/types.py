...
from google.cloud.devtools.resultstore.v2.proto import common_pb2
...
from google.cloud.devtools.resultstore.v2.proto import coverage_pb2
from google.cloud.devtools.resultstore.v2.proto import coverage_summary_pb2
from google.cloud.devtools.resultstore.v2.proto import download_metadata_pb2
from google.cloud.devtools.resultstore.v2.proto import file_pb2
from google.cloud.devtools.resultstore.v2.proto import file_processing_error_pb2
...
from google.cloud.devtools.resultstore.v2.proto import test_suite_pb2
...
for module in _local_modules:
      for name, message in get_messages(module).items():
          message.__module__ = 'google.cloud.devtools.resultstore.v2.types'
          setattr(sys.modules[__name__], name, message)
          names.append(name)
