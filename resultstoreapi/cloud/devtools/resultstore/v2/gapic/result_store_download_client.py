...
from google.cloud.devtools.resultstore.v2.gapic import result_store_download_client_config
from google.cloud.devtools.resultstore.v2.gapic.transports import result_store_download_grpc_transport
...
class ResultStoreDownloadClient(object):
    ...
    def get_invocation(
        ...
        Example:
            ...
            >>>
            >>> client = v2.ResultStoreDownloadClient()
            >>>
    ...
    def search_invocations(
        ...
        Example:
            ...
            >>> for element in client.search_invocations():
            ...     # process element
            ...     pass
            >>>
            >>>
            ...
            >>> for page in client.search_invocations().pages:
            ...     for element in page:
            ...         # process element
            ...         pass
        ...
        Returns:
            ...
            An iterable of :class:`~google.cloud.devtools.resultstore.v2.types.Invocation` instances.
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['search_invocations'], retry=retry, timeout=timeout, metadata=metadata),
            request=request,
            items_field='invocations',
    ...
    def get_invocation_download_metadata(
        ...
        Returns:
            A :class:`~google.cloud.devtools.resultstore.v2.types.DownloadMetadata` instance.
    ...
    def list_configurations(
        ...
        Example:
            ...
            >>>
            >>> # Iterate over all results
            >>> for element in client.list_configurations():
            ...     # process element
            ...     pass
            >>>
            >>>
            ...
            >>>
            >>> # Iterate over results one page at a time
            >>> for page in client.list_configurations().pages:
            ...     for element in page:
            ...         # process element
            ...         pass
        ...
        Returns:
            A :class:`~google.api_core.page_iterator.PageIterator` instance.
            An iterable of :class:`~google.cloud.devtools.resultstore.v2.types.Configuration` instances.
            You can also iterate over the pages of the response
            using its `pages` property.
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_configurations'], retry=retry, timeout=timeout, metadata=metadata),
            request=request,
            items_field='configurations',
            request_token_field='page_token',
            response_token_field='next_page_token',
        )
        return iterator
    ...
    def list_targets(
        ...
        Example:
            ...
            >>>
            >>> # Iterate over all results
            >>> for element in client.list_targets():
            ...     # process element
            ...     pass
            >>>
            >>>
            ...
            >>>
            >>> # Iterate over results one page at a time
            >>> for page in client.list_targets().pages:
            ...     for element in page:
            ...         # process element
            ...         pass
        ...
        Returns:
            A :class:`~google.api_core.page_iterator.PageIterator` instance.
            An iterable of :class:`~google.cloud.devtools.resultstore.v2.types.Target` instances.
            You can also iterate over the pages of the response
            using its `pages` property.
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_targets'], retry=retry, timeout=timeout, metadata=metadata),
            request=request,
            items_field='targets',
            request_token_field='page_token',
            response_token_field='next_page_token',
    ...
    def list_configured_targets(
        ...
        Example:
            ...
            >>>
            >>> # Iterate over all results
            >>> for element in client.list_configured_targets():
            ...     # process element
            ...     pass
            >>>
            >>>
            ...
            >>>
            >>> # Iterate over results one page at a time
            >>> for page in client.list_configured_targets().pages:
            ...     for element in page:
            ...         # process element
            ...         pass
        ...
        Returns:
            A :class:`~google.api_core.page_iterator.PageIterator` instance.
            An iterable of :class:`~google.cloud.devtools.resultstore.v2.types.ConfiguredTarget` instances.
            You can also iterate over the pages of the response
            using its `pages` property.
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_configured_targets'], retry=retry, timeout=timeout, metadata=metadata),
            request=request,
            items_field='configured_targets',
            request_token_field='page_token',
            response_token_field='next_page_token',
        )
        return iterator
    ...
    def list_actions(
        ...
        Example:
            ...
            >>>
            >>> # Iterate over all results
            >>> for element in client.list_actions():
            ...     # process element
            ...     pass
            >>>
            >>>
            ...
            >>>
            >>> # Iterate over results one page at a time
            >>> for page in client.list_actions().pages:
            ...     for element in page:
            ...         # process element
            ...         pass
        ...
        Returns:
            A :class:`~google.api_core.page_iterator.PageIterator` instance.
            An iterable of :class:`~google.cloud.devtools.resultstore.v2.types.Action` instances.
            You can also iterate over the pages of the response
            using its `pages` property.
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_actions'], retry=retry, timeout=timeout, metadata=metadata),
            request=request,
            items_field='actions',
            request_token_field='page_token',
            response_token_field='next_page_token',
    ...
    def list_file_sets(
        ...
        Example:
            ...
            >>>
            >>> # Iterate over all results
            >>> for element in client.list_file_sets():
            ...     # process element
            ...     pass
            >>>
            >>>
            ...
            >>>
            >>> # Iterate over results one page at a time
            >>> for page in client.list_file_sets().pages:
            ...     for element in page:
            ...         # process element
            ...         pass
        ...
        Returns:
            A :class:`~google.api_core.page_iterator.PageIterator` instance.
            An iterable of :class:`~google.cloud.devtools.resultstore.v2.types.FileSet` instances.
            You can also iterate over the pages of the response
            using its `pages` property.
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_file_sets'], retry=retry, timeout=timeout, metadata=metadata),
            request=request,
            items_field='file_sets',
            request_token_field='page_token',
            response_token_field='next_page_token',
        )
        return iterator
    ...
    def traverse_file_sets(
        ...
        Example:
            ...
            >>>
            >>> # Iterate over all results
            >>> for element in client.traverse_file_sets():
            ...     # process element
            ...     pass
            >>>
            >>>
            ...
            >>>
            >>> # Iterate over results one page at a time
            >>> for page in client.traverse_file_sets().pages:
            ...     for element in page:
            ...         # process element
            ...         pass
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['traverse_file_sets'], retry=retry, timeout=timeout, metadata=metadata),
            request=request,
            items_field='file_sets',
            request_token_field='page_token',
            response_token_field='next_page_token',
