...
from google.devtools.resultstore_v2.gapic import result_store_file_download_client_config
from google.devtools.resultstore_v2.gapic.transports import result_store_file_download_grpc_transport
...
class ResultStoreFileDownloadClient(object):
    ...
    def get_file(
        ...
        Example:
            ...
            >>>
            >>> client = resultstore_v2.ResultStoreFileDownloadClient()
            >>>
        ...
        Returns:
            Iterable[~google.devtools.resultstore_v2.types.GetFileResponse].
    ...
    def get_file_tail(
        ...
        Returns:
            A :class:`~google.devtools.resultstore_v2.types.GetFileTailResponse` instance.
