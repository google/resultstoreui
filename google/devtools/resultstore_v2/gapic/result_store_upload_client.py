...
from google.devtools.resultstore_v2.gapic import result_store_upload_client_config
from google.devtools.resultstore_v2.gapic.transports import result_store_upload_grpc_transport
...
from google.devtools.resultstore_v2.proto import resultstore_file_download_pb2_grpc
from google.devtools.resultstore_v2.proto import resultstore_upload_pb2
from google.devtools.resultstore_v2.proto import resultstore_upload_pb2_grpc
...
class ResultStoreUploadClient(object):
    ...
    def create_invocation(
        ...
        Args:
            ...
            invocation_id (str): The invocation ID. It is optional, but strongly recommended.
                ...
                are allowed too.
            invocation (Union[dict, ~google.devtools.resultstore_v2.types.Invocation]): The invocation to create.  Its name field will be ignored, since the name
                will be derived from the id field above and assigned by the server.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.devtools.resultstore_v2.types.Invocation`
            ...
            auto_finalize_time (Union[dict, ~google.devtools.resultstore_v2.types.Timestamp]): By default, Invocations are auto-finalized if they are not modified for 24
                hours. If you need auto-finalize to happen sooner, set this field to the
                time you'd like auto-finalize to occur.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.devtools.resultstore_v2.types.Timestamp`
    ...
    def update_invocation(
        ...
        Args:
            invocation (Union[dict, ~google.devtools.resultstore_v2.types.Invocation]): Contains the name and the fields of the invocation to be updated.
                The name format must be: invocations/${INVOCATION_ID}

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.devtools.resultstore_v2.types.Invocation`
            update_mask (Union[dict, ~google.devtools.resultstore_v2.types.FieldMask]): Indicates which fields to update.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.devtools.resultstore_v2.types.FieldMask`
    ...
    def merge_invocation(
        ...
        Args:
            ...
            invocation (Union[dict, ~google.devtools.resultstore_v2.types.Invocation]): Contains the name and the fields of the invocation to be merged. The
                name format must be: invocations/${INVOCATION_ID}

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.devtools.resultstore_v2.types.Invocation`
            update_mask (Union[dict, ~google.devtools.resultstore_v2.types.FieldMask]): Indicates which fields to merge.
    ...
    def touch_invocation(
        ...
        Returns:
            A :class:`~google.devtools.resultstore_v2.types.TouchInvocationResponse` instance.
    ...
    def finalize_invocation(
        ...
        Returns:
            A :class:`~google.devtools.resultstore_v2.types.FinalizeInvocationResponse` instance.
    ...
    def create_target(
        ...
        Args:
            ...
            target (Union[dict, ~google.devtools.resultstore_v2.types.Target]): The target to create.  Its name field will be ignored, since the name will
                be derived from the id field above and assigned by the server.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.devtools.resultstore_v2.types.Target`
            authorization_token (str): This is a token to authorize access to this invocation. It must be set to
                the same value that was provided in the CreateInvocationRequest.
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
    ...
    def update_target(
        ...
        Args:
            target (Union[dict, ~google.devtools.resultstore_v2.types.Target]): Contains the name and the fields of the target to be updated. The
                name format must be:
    ...
    def merge_target(
        ...
        Args:
            request_id (str): A unique identifier for this request. Must be set to a different value for
                ...
                request if the last successful operation on the resource had the same
                request ID.  Restricted to 36 Unicode characters.
            target (Union[dict, ~google.devtools.resultstore_v2.types.Target]): Contains the name and the fields of the target to be merged. The
                name format must be:
                invocations/${INVOCATION_ID}/targets/${url_encode(TARGET_ID)}
    ...
    def finalize_target(
        ...
        Returns:
            A :class:`~google.devtools.resultstore_v2.types.FinalizeTargetResponse` instance.
    ...
    def create_configured_target(
        ...
        Args:
            ...
            configured_target (Union[dict, ~google.devtools.resultstore_v2.types.ConfiguredTarget]): The configured target to create. Its name field will be ignored, since the
                name will be derived from the id field above and assigned by the server.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.devtools.resultstore_v2.types.ConfiguredTarget`
            authorization_token (str): This is a token to authorize access to this invocation. It must be set to
                the same value that was provided in the CreateInvocationRequest.
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
    ...
    def update_configured_target(
        ...
        Args:
            configured_target (Union[dict, ~google.devtools.resultstore_v2.types.ConfiguredTarget]): Contains the name and the fields of the configured target to be
    ...
    def finalize_configured_target(
        ...
        Returns:
            A :class:`~google.devtools.resultstore_v2.types.FinalizeConfiguredTargetResponse` instance.
    ...
    def create_action(
        ...
        Args:
            ...
            action_id (str): The action identifier. It can be any string up to 512 Unicode
                ...
                build action.
            action (Union[dict, ~google.devtools.resultstore_v2.types.Action]): The action to create.  Its name field will be ignored, since the
                name will be derived from the id field above and assigned by the server.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.devtools.resultstore_v2.types.Action`
            authorization_token (str): This is a token to authorize access to this invocation. It must be set to
                the same value that was provided in the CreateInvocationRequest.
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
    ...
    def update_action(
        ...
        Args:
            action (Union[dict, ~google.devtools.resultstore_v2.types.Action]): Contains the name and the fields of the action to be updated. The
                name format must be:
    ...
    def merge_action(
        ...
        Args:
            request_id (str): A unique identifier for this request. Must be set to a different value for
                ...
                request if the last successful operation on the resource had the same
                request ID.  Restricted to 36 Unicode characters.
            action (Union[dict, ~google.devtools.resultstore_v2.types.Action]): Contains the name and the fields of the action to be merged. The
                name format must be:
                invocations/${INVOCATION_ID}/targets/${url_encode(TARGET_ID)}/configuredTargets/${url_encode(CONFIG_ID)}/actions/${url_encode(ACTION_ID)}
    ...
    def create_configuration(
        ...
        Args:
            ...
            config_id (str): The configuration identifier. It can be any string up to 256 Unicode
                ...
                reserved id '-'.
            configuration (Union[dict, ~google.devtools.resultstore_v2.types.Configuration]): The configuration to create. Its name field will be ignored, since the name
                will be derived from the id field above and assigned by the server.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.devtools.resultstore_v2.types.Configuration`
            authorization_token (str): This is a token to authorize access to this invocation. It must be set to
                the same value that was provided in the CreateInvocationRequest.
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
    ...
    def update_configuration(
        ...
        Args:
            configuration (Union[dict, ~google.devtools.resultstore_v2.types.Configuration]): Contains the name and fields of the configuration to be updated. The
                name format must be:
    ...
    def create_file_set(
        ...
        Args:
            ...
            file_set_id (str): The file set identifier. It can be any string up to 256 Unicode characters
                long.
            file_set (Union[dict, ~google.devtools.resultstore_v2.types.FileSet]): The file set to create. Its name field will be ignored, since the name will
                be derived from the id field above and assigned by the server.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.devtools.resultstore_v2.types.FileSet`
            authorization_token (str): This is a token to authorize access to this invocation. It must be set to
                the same value that was provided in the CreateInvocationRequest.
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
    ...
    def update_file_set(
        ...
        Args:
            file_set (Union[dict, ~google.devtools.resultstore_v2.types.FileSet]): Contains the name and fields of the file set to be updated. The name
                format must be:
    ...
    def merge_file_set(
        ...
        Args:
            request_id (str): A unique identifier for this request. Must be set to a different value for
                ...
                request if the last successful operation on the resource had the same
                request ID.  Restricted to 36 Unicode characters.
            file_set (Union[dict, ~google.devtools.resultstore_v2.types.FileSet]): Contains the name and fields of the file set to be merged. The name
                format must be:
                invocations/${INVOCATION_ID}/fileSets/${url_encode(FILE_SET_ID)}
    ...
    def upload_batch(
        ...
        Args:
            ...
            uploader_state (bytes): Client-specific data used to resume batch upload if an error occurs
                ...
                -  it allows for a larger payload, since the contents are never
                   inspected/compared; The size of the message must be within 1 MiB. Too
                   large requests will be rejected.
            upload_requests (list[Union[dict, ~google.devtools.resultstore_v2.types.UploadRequest]]): The individual upload requests for this batch.
                ...
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.devtools.resultstore_v2.types.UploadRequest`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
                be retried using a default configuration.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.devtools.resultstore_v2.types.UploadBatchResponse` instance.
    ...
    def get_invocation_upload_metadata(
        ...
        Returns:
            A :class:`~google.devtools.resultstore_v2.types.UploadMetadata` instance.
